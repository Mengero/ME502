from simulation_utils.dpdz_f_2ph_Kim_2012 import dpdz_f_2ph_Kim_2012
...
def DP_ref_2ph(self,P_ro,G_ref,x_ro,h_ri,z_i,z_o,dx,Dh,q_H):
    ...
    h_ri_v_tmp=CP.PropsSI('H','P',P_ri_tmp*1e3,'Q',1,self.fld)/1e3      # [kJ/kg]
    h_ri_l_tmp=CP.PropsSI('H','P',P_ri_tmp*1e3,'Q',0,self.fld)/1e3      # [kJ/kg]
