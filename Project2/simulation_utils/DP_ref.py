...
from simulation_utils.dpdz_f_roundtube_churchill import dpdz_f_roundtube_churchill
import simulation_utils.void_fraction
...
def DP_ref_2ph(self,Re,roughness,P_ri,G_ref,x_ri,h_ro,z_i,z_o,dx,Dh):
    ...
    [alpha_ri,rho_ref_tmp]=simulation_utils.void_fraction.void_fraction(self,P_ri,x_ri)
    [alpha_ro_tmp,rho_ref_tmp]=simulation_utils.void_fraction.void_fraction(self,P_ro_tmp,x_ro_tmp)
