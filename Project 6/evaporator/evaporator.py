...
from evaporator.simulation_utils.airsidehtc_chang_wang import airsidehtc_chang_wang
from evaporator.epsilon_NTU import epsilon_NTU
...
def evaporator_system(Ref,T_cro,P_cro,m_dot_ref,Tsh_ro,T_ai,P_ai,RH_ai,m_dot_air,N_segment,P_ro_tmp):
    '''
