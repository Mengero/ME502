...
Q_external = 2.5; Q_batterygenerating = 5
...
ax1.set_xlabel('time [hr]',fontsize=24)
ax1.tick_params(axis='both', which='major', labelsize=20)
fig.savefig('Baseline_Ts_zoomin_ini.png')
# 
fig, ax1 = plt.subplots(figsize=(11, 6.5))
ax1.plot(t,Q_battery,label='Q_battery')
ax1.plot(t,Q_air,label='Q_air')
...
ax1.set_xlabel('time [hr]',fontsize=24)
ax1.tick_params(axis='both', which='major', labelsize=20)
fig.savefig('Baseline_Qs_zoomin_ini.png')
# 
fig, ax1 = plt.subplots(figsize=(11, 6.5))
ax1.plot(t,Q_ht_air_battery,label='air_battery')
ax1.plot(t,Q_ht_air_device,label='air_device')
...
ax1.set_xlabel('time [hr]',fontsize=24)
ax1.tick_params(axis='both', which='major', labelsize=20)
fig.savefig('Baseline_Qs_zoomin_ini2.png')
# 
fig, ax1 = plt.subplots(figsize=(11, 6.5))
ax1.plot(t,Tdb_air,label='Tdb_air')
ax1.plot(t,Tdp_air,label='Tdp_air')
...
ax1.set_xlabel('time [hr]',fontsize=24)
ax1.tick_params(axis='both', which='major', labelsize=20)
fig.savefig('Baseline_Ts_zoomin_lat.png')
# 
fig, ax1 = plt.subplots(figsize=(11, 6.5))
ax1.plot(t,Q_battery,label='Q_battery')
ax1.plot(t,Q_air,label='Q_air')
...
ax1.set_xlabel('time [hr]',fontsize=24)
ax1.tick_params(axis='both', which='major', labelsize=20)
fig.savefig('Baseline_Qs_zoomin_lat.png')
# 
fig, ax1 = plt.subplots(figsize=(11, 6.5))
ax1.plot(t,Q_ht_air_battery,label='air_battery')
ax1.plot(t,Q_ht_air_device,label='air_device')
...
ax1.set_xlabel('time [hr]',fontsize=24)
ax1.tick_params(axis='both', which='major', labelsize=20)
fig.savefig('Baseline_Qs_zoomin_lat2.png')